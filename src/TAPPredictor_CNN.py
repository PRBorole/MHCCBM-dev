...
class EarlyStopping:
    def __init__(self, patience=200, min_delta=0, verbose=False):
        """
    ...
    def train_loop(self, train_loader, valid_loader, test_loader, **kwargs):
        ...
        for epoch in range(nepochs):
            ...
            if valid_loader is not None:
                ...
                print("epoch: ", epoch+1, "val_f1: ", val_f1, "val_auroc: ", val_auroc, "val_auprc: ", val_auprc)
            ...
            if test_loader is not None:
                ...
                # Log validation F1 score, AUROC, and AUPRC
                print("epoch: ", epoch+1, "test_f1: ", test_f1, "test_auroc: ", test_auroc, "test_auprc: ", test_auprc)
